...
aps_gauge.set(50);               // set initial value

const aps_value_text = document.getElementById("aps-value");
aps_value_text.innerHTML = "50%";
...
socket.on("feedback", (msg) => {
    ...
    angle_value_text.innerHTML = (angle * 100).toFixed(0) + "%";
});
