...
path="/home/reach-002/Documents/MARV-TEST-BED"
#path="/home/viktor/Documents"

echo "MARV System (With RNS) Initializing..."

sleep 1

# Initialize CAN
echo "Starting CAN services"
$path/RNS/start_scripts/canconfig.sh
sleep 1
...
source $path/RNS/colcon_ws/install/setup.bash
"
