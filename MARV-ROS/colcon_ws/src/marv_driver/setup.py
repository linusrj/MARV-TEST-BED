...
setup(
    ...
    entry_points={
        'console_scripts': [
            ...
            #'keyboard_steering = marv_driver.marv_keyboard_steering:main',
            #'keyboard_input = marv_driver.keyboard_input:main',
            #'keyboard_listener = marv_driver.keyboard_listener:main',
            #'controller_input = marv_driver.controller_input:main',
	    'web_input = marv_driver.web_input:main',
	    ],
    },
)
