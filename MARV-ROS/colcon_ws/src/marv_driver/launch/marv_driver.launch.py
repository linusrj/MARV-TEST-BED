...
#            package='marv_driver',
#            #namespace='',
#            node_executable='keyboard_steering',
#            name='keyboard_steering',
#            parameters = [config],
#            output='screen', 
#            emulate_tty=True,
#            arguments=['--ros-args', '--log-level', logger]
...
#            package='marv_driver',
#            #namespace='',
#            node_executable='keyboard_input',
#            name='keyboard_input',
#            parameters = [config],
#            output='screen', 
#            emulate_tty=True,
...
#            package='marv_driver',
#            #namespace='',
#            node_executable='keyboard_listener',
...
#            package='marv_driver',
#            #namespace='',
#           node_executable='controller_input',
